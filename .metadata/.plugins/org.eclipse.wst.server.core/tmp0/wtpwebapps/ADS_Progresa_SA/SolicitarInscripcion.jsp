...
<div class="container" style="margin-top: 4%">
		...
		<form id="id_form">
			...
			<div class="row" style="display: flex; justify-content: center">
				<div class="form-group col-md-4">
					<label class="control-label" for="id_grad"> Grado Académico </label> <select class="form-control" id="id_grado" name="grado">
				...
				<div class="form-group col-md-4">
					<label class="control-label" for="id_expe">Años de experiencia</label>
						...
						<option value="4">5 a 10 años</option>
						<option value="5">11 a 20 años</option>
					</select>
				</div>
			...
			<div class="row" style="display: flex; justify-content: center">
				...
				<div class="form-group col-md-4">
					<label class="control-label" for="id_tele">Teléfono</label> <input
									...
									.bootstrapValidator(
											{
												...
												fields : {
													...
													telefono : {
														...
														validators : {
															...
															stringLength : {
																min : 9,
																max : 9,
																message : 'El teléfono tiene 9 caracteres'
															}
														}
													},
													grado : {
													...
													experiencia : {
														...
														validators : {
															notEmpty : {
																message : 'Los años de experiencia es requerido'
															},
														}
													},
													experiencia : {
